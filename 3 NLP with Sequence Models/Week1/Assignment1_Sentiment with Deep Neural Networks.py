...
def tweet_to_tensor(tweet, vocab_dict, unk_token='__UNK__', verbose=False):
    ...
    for word in word_l:
        ...
        word_ID = vocab_dict.get(word, vocab_dict.get(unk_ID,0))
    ### END CODE HERE ###
...
### START CODE HERE (Replace instances of 'None' with your code) ###
        ...
        #w = trax.fastmath.random.normal(random_key, input_shape)*self._init_stdev
...
def compute_accuracy(preds, y, y_weights):
    ...
    #is_pos = np.array([True if pred[0] < pred[1] else False for pred in preds])
